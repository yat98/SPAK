...
class OperatorRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'bagian'=>'required|string|in:subbagian kemahasiswaan,subbagian pendidikan dan pengajaran,subbagian umum & bmn,front office,operator perpustakaan,sespri dekan',
