    ...
    public function getAllPengajuan(){
        if(isset(Auth::user()->nim)){
            ...
            if(Auth::user()->bagian == 'front office'){
                ...
                $pengajuanSurat = PengajuanSuratKegiatanMahasiswa::whereIn('pengajuan_surat_kegiatan_mahasiswa.status',['disposisi','disposisi dekan','disposisi wd1','disposisi wd2','disposisi wd3','disposisi kabag','disposisi kasubag','disposisi selesai']);
            }
