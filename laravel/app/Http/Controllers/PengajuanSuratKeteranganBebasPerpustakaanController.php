...
class PengajuanSuratKeteranganBebasPerpustakaanController extends Controller
{
    ...
    public function getAllPengajuanByNim(Mahasiswa $mahasiswa){
        return DataTables::of(PengajuanSuratKeteranganBebasPerpustakaan::where('pengajuan_surat_keterangan_bebas_perpustakaan.nim',$mahasiswa->nim)
                                    ->select('mahasiswa.nama','pengajuan_surat_keterangan_bebas_perpustakaan.*','mahasiswa.nim')
                                    ->join('mahasiswa','pengajuan_surat_keterangan_bebas_perpustakaan.nim','=','mahasiswa.nim')
                                    ->with(['mahasiswa']))
                        ->addColumn('aksi', function ($data) {
    ...
    private function isSuratDiajukanExists(){
        $suratPerlengkapan = PengajuanSuratKeteranganBebasPerpustakaan::where('nim',Auth::user()->nim)
