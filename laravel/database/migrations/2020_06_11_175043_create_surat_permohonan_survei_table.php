...
class CreateSuratPermohonanSurveiTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('surat_permohonan_survei', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('surat_permohonan_survei');
    }
}
