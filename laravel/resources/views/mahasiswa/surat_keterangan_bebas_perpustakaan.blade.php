                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-6 text-right">
                                        <a href="{{ url('mahasiswa/surat-keterangan-bebas-perpustakaan/pengajuan/create')}}"
...
@section('datatables-javascript')
    <script>
        let link = "{{ url('mahasiswa/surat-keterangan-bebas-perpustakaan/pengajuan') }}";
        let linkSurat = "{{ url('mahasiswa/surat-keterangan-bebas-perpustakaan') }}";
        ...
        $('#datatables').DataTable({
            ...
            columnDefs: [{
                        ...
                        },
                        {
                            ...
                            "data": "aksi",
                            "render": function ( data, type, row, meta ) {
                                let action = `<a href="${link+'/'+row.id}/progress" class="dropdown-item btn-surat-perpustakaan-progress" data-toggle="modal" data-target="#exampleModal">Progres Surat</a>`;

                                if(row.status == 'Diajukan' || row.status == 'Ditolak'){
                                    action += `<a href="${link+'/'+row.id}" class="dropdown-item pengajuan-surat-perpustakaan-detail" data-toggle="modal" data-target="#suratPerpustakaan">Detail</a>`;
                                }else{
                                    action += `<a href="${linkSurat+'/'+row.id}" class="dropdown-item btn-surat-perpustakaan-detail" data-toggle="modal" data-target="#suratPerpustakaan">
                                                Detail</a>`;
                                }
