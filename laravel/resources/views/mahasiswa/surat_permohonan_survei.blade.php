                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-6 text-right">
                                        <a href="{{ url('mahasiswa/surat-permohonan-survei/pengajuan/create')}}"
...
@section('datatables-javascript')
    <script>
        let link = "{{ url('mahasiswa/surat-permohonan-survei/pengajuan') }}";
        let linkSurat = "{{ url('mahasiswa/surat-permohonan-survei') }}";
                        ...
                        },
                        {
                            ...
                            "render": function ( data, type, row, meta ) {
                                ...
                                if(row.status == 'Diajukan' || row.status == 'Ditolak'){
                                    action += `<a href="${link+'/'+row.id}" class="dropdown-item pengajuan-surat-survei-detail" data-toggle="modal" data-target="#suratSurvei">Detail</a>`;
                                }else{
                                    action += `<a href="${linkSurat+'/'+row.id}" class="dropdown-item btn-surat-survei-detail" data-toggle="modal" data-target="#suratSurvei">
                                                Detail</a>`;
                                }
