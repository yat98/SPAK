...
@php
    $menimbang = "<ol type=\"a\">
                    ...
                    <li>Bahwa nama-nama yang tercantum dalam lampiran surat keputusan ini, merupakan panitia kegiatan ".$pengajuanKegiatan->nama_kegiatan." ".$pengajuanKegiatan->ormawa->nama." Jurusan ".$pengajuanKegiatan->ormawa->pimpinanOrmawa->first()->mahasiswa->prodi->jurusan->nama_jurusan." yang dipandang mampu mengemban tugas dan memiliki tanggung jawab dalam kegiatan yang dimaksud;</li>
    ...
    $memperhatikan = "Surat Permohonan dari ".$pengajuanKegiatan->ormawa->nama." Jurusan ".$pengajuanKegiatan->ormawa->pimpinanOrmawa->first()->mahasiswa->prodi->jurusan->nama_jurusan." Fakultas Teknik Universitas Negeri Gorontalo, Nomor:".$pengajuanKegiatan->nomor_surat_permohonan_kegiatan." tanggal ".$pengajuanKegiatan->created_at->isoFormat('D MMMM Y');
    $menetapkan = "KEPUTUSAN DEKAN FAKULTAS TEKNIK UNIVERSITAS NEGERI GORONTALO TENTANG PANITIA KEGIATAN ".strtoupper($pengajuanKegiatan->nama_kegiatan)." JURUSAN ".strtoupper($pengajuanKegiatan->ormawa->pimpinanOrmawa->first()->mahasiswa->prodi->jurusan->nama_jurusan);
    $kesatu = "Mengesahkan panitia kegiatan ".$pengajuanKegiatan->nama_kegiatan."  ".$pengajuanKegiatan->ormawa->nama." Jurusan ".$pengajuanKegiatan->ormawa->pimpinanOrmawa->first()->mahasiswa->prodi->jurusan->nama_jurusan." Fakultas Teknik Universitas Negeri Gorontalo sebagaimana terlampir;";
