                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-6 text-right">
                                        <a href="{{ url('operator/surat-keterangan-bebas-perpustakaan/pengajuan/create')}}"
...
@section('datatables-javascript')
    <script>
        let link = "{{ url('operator/surat-keterangan-bebas-perpustakaan/pengajuan') }}";
        let linkSurat = "{{ url('operator/surat-keterangan-bebas-perpustakaan') }}";
        ...
        $('#datatables').DataTable({
            ...
            columnDefs: [{
                        ...
                        },
                        {
                            ...
                            "render": function ( data, type, row, meta ) {
                                @if(Auth::user()->bagian == 'front office')
                                    return `<div class="d-inline-block">
                                                ...
                                                <div class="dropdown-menu navbar-dropdown border border-dark" aria-labelledby="aksi">
                                                    <a href="${link+'/'+row.id}/progress" class="dropdown-item btn-surat-perpustakaan-progress" data-toggle="modal" data-target="#exampleModal">Progres Surat</a>
                                                    <a href="${link+'/'+row.id}" class="dropdown-item pengajuan-surat-perpustakaan-detail" data-toggle="modal" data-target="#suratPerpustakaan">Detail</a>
                                ...
                                @else
                                    let aksi = `<a href="${link+'/'+row.id}" class="dropdown-item pengajuan-surat-perpustakaan-detail" data-toggle="modal" data-target="#suratPerpustakaan">Detail</a>`;
                                    if(row.status == 'Diajukan'){
                                        ...
                                        aksi = `<a href="${link+'/'+row.id}" class="dropdown-item pengajuan-surat-perpustakaan-detail" data-toggle="modal" data-target="#suratPerpustakaan">Detail</a>`;
                                    }else{
                                        aksi = `<a href="${linkSurat+'/'+row.id}" class="dropdown-item btn-surat-perpustakaan-detail" data-toggle="modal" data-target="#suratPerpustakaan">Detail</a>`;
                                    }
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ url('operator/surat-keterangan-bebas-perpustakaan/pengajuan/all') }}',
            columns: [{
                    data: 'mahasiswa.nim',
                },
                {
                            ...
                            "render": function ( data, type, row, meta ) {
                                @if(Auth::user()->bagian != 'front office')
                                    return `<div class="d-inline-block">
                                                ...
                                                <div class="dropdown-menu navbar-dropdown border border-dark" aria-labelledby="aksi">
                                                    <a href="${linkSurat+'/'+row.id}" class="dropdown-item btn-surat-perpustakaan-detail" data-toggle="modal" data-target="#suratPerpustakaan">
                                                            Detail</a>
                                                    <a href="${linkSurat+'/'+row.id+'/cetak'}" class="dropdown-item">Cetak</a>
                                                </div>
                                            </div>`;
                                @else
                                    let action = `<a href="${linkSurat+'/'+row.id}" class="dropdown-item btn-surat-perpustakaan-detail" data-toggle="modal" data-target="#suratPerpustakaan">
                                                    Detail</a>`;
