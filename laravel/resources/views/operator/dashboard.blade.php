    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                @endif
                <div class="row">
                    <div class="@if(Auth::user()->bagian != 'operator perpustakaan') col-md-4 @else col-md-6 @endif stretch-card grid-margin">
                    ...
                    @if(Auth::user()->bagian != 'operator perpustakaan')
                        @if(Session::get('jabatan') != 'sespri dekan')
                        ...
                        <div class="col-md-6 stretch-card grid-margin">
                            <div class="card bg-gradient-info card-img-holder text-white">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-text">
                                        <a href="{{ url('operator/surat-keterangan-bebas-perpustakaan') }}" class="text-white">Lihat data surat</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                    ...
                    @endif
                    @if(Auth::user()->bagian == 'front office' || Auth::user()->bagian == 'subbagian umum & bmn')
                        <div class="col-md-4 stretch-card grid-margin">
                            <div class="card bg-gradient-info card-img-holder text-white">
                                <div class="card-body">
                                    <img src="{{ asset('image/circle.svg') }}" class="card-img-absolute"
                                    ...
                                    <h6 class="card-text">
                                        <a href="{{ url('operator/surat-keterangan-bebas-perlengkapan') }}" class="text-white">Lihat data surat</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                ...
                @endif
                @if(Auth::user()->bagian == 'front office' || Auth::user()->bagian == 'operator perpustakaan')
                    <div class="row">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table display no-warp" id='datatables19' width="100%">
                                            <thead>
                                                <tr>
                                                    <th data-priority="1"> Nama Kegiatan</th>
                                                    <th> Ormawa</th>
...
@section('datatables-javascript')
    <script>
        ...
        @if(Auth::user()->bagian == 'front office' || Auth::user()->bagian == 'subbagian kemahasiswaan' || Auth::user()->bagian == 'sespri dekan')
        ...
        @if(Auth::user()->bagian == 'front office' || Auth::user()->bagian == 'subbagian umum & bmn')
            let linkSuratPerlengkapan = "{{ url('operator/surat-keterangan-bebas-perlengkapan') }}";
        @endif

        @if(Auth::user()->bagian == 'front office' || Auth::user()->bagian == 'operator perpustakaan')
            let linkSuratPerpustakaan = "{{ url('operator/surat-keterangan-bebas-perpustakaan') }}";
        @endif
        ...
        @if(Auth::user()->bagian == 'front office' || Auth::user()->bagian == 'subbagian umum & bmn')
            $('#datatables17').DataTable({
                                ...
                                "render": function ( data, type, row, meta ) {
                                    @if(Auth::user()->bagian != 'front office')
                                        return `<div class="d-inline-block">
                                                    ...
                                                    <div class="dropdown-menu navbar-dropdown border border-dark" aria-labelledby="aksi">
                                                        <a href="${linkSuratPerlengkapan+'/'+row.id}" class="dropdown-item btn-surat-perlengkapan-detail" data-toggle="modal" data-target="#suratPerlengkapan">
                                                                Detail</a>
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ url('operator/surat-keterangan-bebas-perlengkapan/all') }}',
                columns: [{
                        data: 'mahasiswa.nama',
                    },
                    {
        ...
        @if(Auth::user()->bagian == 'front office' || Auth::user()->bagian == 'operator perpustakaan')
            $('#datatables18').DataTable({
                                ...
                                "render": function ( data, type, row, meta ) {
                                    @if(Auth::user()->bagian != 'front office')
                                        return `<div class="d-inline-block">
                                                    ...
                                                    <div class="dropdown-menu navbar-dropdown border border-dark" aria-labelledby="aksi">
                                                        <a href="${linkSuratPerpustakaan+'/'+row.id}" class="dropdown-item btn-surat-perpustakaan-detail" data-toggle="modal" data-target="#suratPerpustakaan">
                                                                Detail</a>
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ url('operator/surat-keterangan-bebas-perpustakaan/all') }}',
                columns: [{
                        data: 'mahasiswa.nama',
                    },
                    {
                ...
                columnDefs: [{
                            ...
                            },
                            {
                                ...
                                "render": function ( data, type, row, meta ) {
                                    ...
                                    let aksi = `<a href="${linkSuratKegiatan+'/pengajuan/'+row.id}" class="dropdown-item">Detail</a>`;
                                    if(row.status == 'Disposisi'){
                                        aksi += `<a href="${linkSuratKegiatan+'/disposisi/create/'+row.id}" class="dropdown-item">Buat Disposisi</a>`;
                                    }else{
                                        aksi += `<a href="${linkSuratKegiatan+'/disposisi/'+row.id+'/cetak'}" class="dropdown-item">Cetak Disposisi</a>
                                                <a href="${linkSuratKegiatan+'/disposisi/'+row.id}" class="dropdown-item btn-disposisi-pengajuan-detail" data-toggle="modal" data-target="#disposisiPengajuan">Detail Disposisi</a>`;
                                    }
