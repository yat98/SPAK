                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-6 text-right">
                                        <a href="{{ url('operator/surat-keterangan-lulus/pengajuan/create')}}"
...
@section('datatables-javascript')
    <script>
        let link = "{{ url('operator/surat-keterangan-lulus/pengajuan') }}";
        let linkSurat = "{{ url('operator/surat-keterangan-lulus') }}";
        ...
        $('#datatables').DataTable({
                                ...
                                @if(Auth::user()->bagian == 'front office')
                                    return `<div class="d-inline-block">
                                                ...
                                                <div class="dropdown-menu navbar-dropdown border border-dark" aria-labelledby="aksi">
                                                    ...
                                                    <a href="${link+'/'+row.id}" class="dropdown-item pengajuan-surat-keterangan-lulus-detail" data-toggle="modal" data-target="#suratKeterangan">Detail</a>
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ url('operator/surat-keterangan-lulus/pengajuan/all') }}',
            columns: [{
                    data: 'mahasiswa.nim',
                },
                {
