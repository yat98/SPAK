                    ...
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-12">
                                        {{ Form::open(['url'=>'pimpinan/laporan']) }}
                                        <div class="form-row">
                                            <div class="form-group col-md-3">
                                                <label for="tahun">Bagian</label>
                                                {{ Form::select('bagian',$bagianList,null,['class'=>'form-control form-control-lg','id'=>'bagian','placeholder'=> '-- Pilih Bagian --']) }}
                                                <div class="text-danger-red mt-1"><small>{{ $errors->first('bagian') }}</small></div>
                                            </div>
                                            <div class="form-group col-md-3">
