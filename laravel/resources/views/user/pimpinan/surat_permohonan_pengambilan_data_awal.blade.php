                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-12 col-md-6">
                                            <h4>Verifikasi Surat Permohonan Pengambilan Data Awal</h4>
                                        </div>
                                    </div>
                                    <hr class="mb-4">
                                    ...
                                    <div class="row">
                                        <div class="col text-center">
                                            ...
                                            <p class="text-muted">
                                                {{ (Session::has('search')) ? Session::get('search') : ' Verifikasi surat permohonan pengambilan data awal belum ada.' }}
                                            </p>
                                        </div>
                                    </div>
                                    @endif
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col text-center">
                                        ...
                                        <p class="text-muted">
                                            {{ (Session::has('search')) ? Session::get('search') : ' Tanda tangan surat permohonan pengambilan data awal belum ada.' }}
                                        </p>
                                    </div>
                                </div>
                                @endif
...
@section('datatables-javascript')
    <script>
        let link = "{{ url('pimpinan/surat-permohonan-pengambilan-data-awal') }}";
        ...
        $('#datatables').DataTable({
                            ...
                            "render": function ( data, type, row, meta ) {
                                return `<div class="d-inline-block">
                                            ...
                                            <div class="dropdown-menu navbar-dropdown border border-dark" aria-labelledby="aksi">
                                                 <a href="${link+'/'+row.id}" class="dropdown-item btn-surat-data-awal-detail" data-toggle="modal" data-target="#exampleModal">
                                                        Detail</a>
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ url('pimpinan/surat-permohonan-pengambilan-data-awal/verifikasi/all') }}',
            columns: [{
                    data: 'mahasiswa.nama',
                },
                {
        ...
        $('#datatables1').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ url('pimpinan/surat-permohonan-pengambilan-data-awal/tanda-tangan/all') }}',
            columns: [{
                    data: 'mahasiswa.nama',
                },
                {
        ...
        $('#datatables2').DataTable({
            ...
            columnDefs: [{
                        ...
                        },
                        {
                            ...
                            "data": "aksi",
                            "render": function ( data, type, row, meta ) {
                                let action = `<a href="${link+'/'+row.id}" class="dropdown-item btn-surat-data-awal-detail" data-toggle="modal" data-target="#exampleModal">
                                                Detail</a>
                                              <a href="${link+'/'+row.id+'/cetak'}" class="dropdown-item">Cetak</a>`;
