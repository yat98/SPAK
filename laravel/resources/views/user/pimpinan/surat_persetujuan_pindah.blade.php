...
@section('datatables-javascript')
    <script>
        let link = "{{ url('pimpinan/surat-persetujuan-pindah') }}";
        ...
        $('#datatables').DataTable({
                            ...
                            "render": function ( data, type, row, meta ) {
                                return `<div class="d-inline-block">
                                            ...
                                            <div class="dropdown-menu navbar-dropdown border border-dark" aria-labelledby="aksi">
                                                 <a href="${link+'/'+row.id}" class="dropdown-item btn-surat-pindah-detail" data-toggle="modal" data-target="#exampleModal">
                                                        Detail</a>
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ url('pimpinan/surat-persetujuan-pindah/verifikasi/all') }}',
            columns: [{
                    data: 'mahasiswa.nama',
                },
                {
        ...
        $('#datatables1').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ url('pimpinan/surat-persetujuan-pindah/tanda-tangan/all') }}',
            columns: [{
                    data: 'mahasiswa.nama',
                },
                {
        ...
        $('#datatables2').DataTable({
            ...
            columnDefs: [{
                        ...
                        },
                        {
                            ...
                            "data": "aksi",
                            "render": function ( data, type, row, meta ) {
                                let action = `<a href="${link+'/'+row.id}" class="dropdown-item btn-surat-pindah-detail" data-toggle="modal" data-target="#exampleModal">
                                                Detail</a>
                                              <a href="${link+'/'+row.id+'/cetak'}" class="dropdown-item">Cetak</a>`;
