                        ...
                        <div class="card bg-gradient-warning card-img-holder text-white">
                            <div class="card-body">
                                <img src="{{ asset('image/circle.svg') }}" class="card-img-absolute"
                                    alt="circle-image" />
                                <h4 class="font-weight-normal mb-3">Verifikasi Surat Rekomendasi<i
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-12 col-md-6">
                                        <h4>Verifikasi Surat Rekomendasi</h4>
                                    </div>
                                </div>
                                <hr class="mb-4">
                                ...
                                <div class="row">
                                    <div class="col text-center">
                                        ...
                                        <p class="text-muted">
                                            {{ (Session::has('search')) ? Session::get('search') : ' Verifikasi surat rekomendasi belum ada.' }}
                                        </p>
                                    </div>
                                </div>
                                @endif
...
@section('datatables-javascript')
    <script>
        let link = "{{ url('pegawai/surat-rekomendasi') }}";
        ...
        $('#datatables').DataTable({
                            ...
                            "render": function ( data, type, row, meta ) {
                                return `<div class="d-inline-block">
                                            ...
                                            <div class="dropdown-menu navbar-dropdown border border-dark" aria-labelledby="aksi">
                                                <a href="${link+'/'+row.id}" class="dropdown-item btn-surat-rekomendasi-detail" data-toggle="modal" data-target="#suratRekomendasi">Detail</a>
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ url('pegawai/surat-rekomendasi/verifikasi/all') }}',
            columns: [{
                    data: 'nama_kegiatan',
                },
                {
        ...
        $('#datatables1').DataTable({
            ...
            columnDefs: [{
                        ...
                        },
                        {
                            ...
                            "data": "aksi",
                            "render": function ( data, type, row, meta ) {
                                let action = ` <a href="${link+'/'+row.id}" class="dropdown-item btn-surat-rekomendasi-detail" data-toggle="modal" data-target="#suratRekomendasi">Detail</a>
                                              <a href="${link+'/'+row.id+'/cetak'}" class="dropdown-item">Cetak</a>`;
