                        ...
                        <div class="card bg-gradient-warning card-img-holder text-white">
                            <div class="card-body">
                                <img src="{{ asset('image/circle.svg') }}" class="card-img-absolute"
                                    alt="circle-image" />
                                <h4 class="font-weight-normal mb-3">Verifikasi Surat Keterangan Kelakuan Baik<i
...
@section('datatables-javascript')
    <script>
        let link = "{{ url('pegawai/surat-keterangan-kelakuan-baik') }}";
        ...
        $('#datatables').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ url('pegawai/surat-keterangan-kelakuan-baik/verifikasi/all') }}',
            columns: [{
                    data: 'mahasiswa.nama',
                },
                {
