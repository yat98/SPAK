...
<div class="row">
    <div class="col-md-12">
      <div class="form-group ">
            ...
            @if ($errors->any())
            @if ($errors->has('nim'))
            {{ Form::select('nim[]',$mahasiswa,isset($suratTugas) ? $suratTugas->mahasiswa : null,['class'=>'form-control form-control-lg','id'=>'mahasiswa_list','multiple'=>"multiple"]) }}
      ...
      <div class="form-group">
            ...
            <div class="form-row">
                ...
                {{ Form::text('tahun',isset($suratTugas)?$suratTugas->created_at->format('Y'):date('Y') ,['class'=>'form-control form-control-lg','disabled'=>'disabled']) }}
                </div>
            </div>    
        </div> 
        <div class="form-group">
