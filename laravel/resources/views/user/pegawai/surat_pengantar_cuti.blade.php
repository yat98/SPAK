            ...
            <div class="content-wrapper">
                <div class="page-header">
                    <h3 class="page-title">
                        ...
                        </span> Surat Persetujuan Cuti</h3>
                </div>
                <div class="row">
                        ...
                        <div class="card bg-gradient-warning card-img-holder text-white">
                            <div class="card-body">
                                <img src="{{ asset('image/circle.svg') }}" class="card-img-absolute"
                                    alt="circle-image" />
                                <h4 class="font-weight-normal mb-3">Verifikasi Surat Persetujuan Cuti<i
...
@section('datatables-javascript')
    <script>
        let link = "{{ url('pegawai/surat-pengantar-cuti') }}";
        ...
        $('#datatables').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ url('pegawai/surat-pengantar-cuti/verifikasi/all') }}',
            columns: [{
                    data: 'nomor_surat',
                },
                {
