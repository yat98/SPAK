...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            {{ Form::select('bagian',['front office'=>'Front Office','operator perpustakaan'=>'Operator Perpustakaan','sespri dekan'=>'Sespri Dekan','subbagian kemahasiswaan'=>'Subbagian Kemahasiswaan','subbagian pendidikan dan pengajaran'=>'Subbagian Pendidikan Dan Pengajaran','subbagian umum & bmn'=>'Subbagian Umum & BMN'],null,['class'=>'form-control form-control-lg is-invalid','id'=>'jabatan','placeholder'=> '-- Pilih Jabatan --']) }}
