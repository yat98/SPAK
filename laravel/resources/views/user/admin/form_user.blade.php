<div class="row">
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            {{ Form::select('jabatan',['dekan'=>'Dekan','wd1'=>'Wakil Dekan 1','wd2'=>'Wakil Dekan 2','wd3'=>'Wakil Dekan 3','kabag tata usaha'=>'Kabag Tata Usaha','kasubag kemahasiswaan'=>'Kasubag Kemahasiswaan','kasubag pendidikan dan pengajaran'=>'Kasubag Pendidikan Dan Pengajaran','kasubag umum & bmn'=>'Kasubag Umum & BMN','kepala perpustakaan'=>'Kepala Perpustakaan'],null,['class'=>'form-control form-control-lg is-invalid','id'=>'jabatan','placeholder'=> '-- Pilih Jabatan --']) }}
