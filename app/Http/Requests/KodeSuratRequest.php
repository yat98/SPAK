...
class KodeSuratRequest extends FormRequest
{
    ...
    public function rules()
    {
        if($this->method() == 'PATCH' || $this->method() == 'PUT'){
            ...
            $jenisSuratRules = 'required|string|in:surat keterangan,surat dispensasi,surat pengantar cuti,surat rekomendasi,surat tugas|unique_with:kode_surat,kode_surat,'.$this->get('id');
        }else{
            $kodeSuratRules = 'required|string|regex:/.+\/+./|unique_with:kode_surat,jenis_surat';
            $jenisSuratRules = 'required|string|in:surat keterangan,surat dispensasi,surat pengantar cuti,surat rekomendasi,surat tugas|unique_with:kode_surat,kode_surat';
        }
        return[
