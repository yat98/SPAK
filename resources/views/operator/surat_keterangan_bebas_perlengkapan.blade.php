                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-12 col-md-6">
                                        <h4>Pengajuan Surat Keterangan Bebas Perlengkapan</h4>
                                    </div>
                                    @if(Auth::user()->bagian == 'front office')
                                    <div class="col-12 col-md-6 text-right">
                                        <a href="{{ url('operator/surat-keterangan-bebas-perlengkapan/pengajuan/create')}}"
                                ...
                                <div class="row">
                                    <div class="col text-center">
                                        ...
                                        <p class="text-muted">
                                            {{ (Session::has('search')) ? Session::get('search') : ' Pengajuan surat keterangan bebas perlengkapan belum ada.' }}
                                        </p>
                                    </div>
                                </div>
                                @endif
...
@section('datatables-javascript')
    <script>
        let link = "{{ url('operator/surat-keterangan-bebas-perlengkapan/pengajuan') }}";
        let linkSurat = "{{ url('operator/surat-keterangan-bebas-perlengkapan') }}";
        ...
        $('#datatables').DataTable({
            ...
            columnDefs: [{
                        ...
                        },
                        {
                            ...
                            "render": function ( data, type, row, meta ) {
                                @if(Auth::user()->bagian == 'front office')
                                    return `<div class="d-inline-block">
                                                ...
                                                <div class="dropdown-menu navbar-dropdown border border-dark" aria-labelledby="aksi">
                                                    ...
                                                    <a href="${link+'/'+row.id}" class="dropdown-item pengajuan-surat-perlengkapan-detail" data-toggle="modal" data-target="#suratPerlengkapan">Detail</a>
                                ...
                                @else
                                    let aksi = `<a href="${link+'/'+row.id}" class="dropdown-item pengajuan-surat-perlengkapan-detail" data-toggle="modal" data-target="#suratPerlengkapan">Detail</a>`;
                                    if(row.status == 'Diajukan'){
                                        ...
                                        aksi = `<a href="${link+'/'+row.id}" class="dropdown-item pengajuan-surat-perlengkapan-detail" data-toggle="modal" data-target="#suratPerlengkapan">Detail</a>`;
                                    }else{
                                        aksi = `<a href="${linkSurat+'/'+row.id}" class="dropdown-item btn-surat-perlengkapan-detail" data-toggle="modal" data-target="#suratPerlengkapan">Detail</a>`;
                                    }
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ url('operator/surat-keterangan-bebas-perlengkapan/pengajuan/all') }}',
            columns: [{
                    data: 'mahasiswa.nim',
                },
                {
                            ...
                            "render": function ( data, type, row, meta ) {
                                @if(Auth::user()->bagian != 'front office')
                                    return `<div class="d-inline-block">
                                                ...
                                                <div class="dropdown-menu navbar-dropdown border border-dark" aria-labelledby="aksi">
                                                    <a href="${linkSurat+'/'+row.id}" class="dropdown-item btn-surat-perlengkapan-detail" data-toggle="modal" data-target="#suratPerlengkapan">
                                                            Detail</a>
                                                    <a href="${linkSurat+'/'+row.id+'/cetak'}" class="dropdown-item">Cetak</a>
                                                </div>
                                            </div>`;
                                @else
                                    let action = `<a href="${linkSurat+'/'+row.id}" class="dropdown-item btn-surat-perlengkapan-detail" data-toggle="modal" data-target="#suratPerlengkapan">
                                                    Detail</a>`;
