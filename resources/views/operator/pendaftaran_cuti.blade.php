                        ...
                        <div class="card bg-gradient-warning card-img-holder text-white">
                            <div class="card-body">
                                ...
                                <h4 class="font-weight-normal mb-3">
                                        @if(Auth::user()->bagian == 'front office') Pengajuan Pendaftaran Cuti 
                                        @else Verfikasi Pendaftaran Cuti
                                        @endif
                                        <i class="mdi mdi-playlist-check mdi-24px float-right"></i>
                                </h4>
                                <h2 class="mb-5">
                                    @if(Auth::user()->bagian == 'front office')  {{ $countAllPengajuan > 0 ? $countAllPengajuan.' Pengajuan Cuti' : 'Pengajuan Cuti Kosong' }}
                                    @else  {{ $countAllPengajuan > 0 ? $countAllPengajuan.' Verifikasi Pengajuan Cuti' : 'Verifikasi Pengajuan Cuti Kosong' }}
                                    @endif
                                </h2>
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-6 text-right">
                                        <a href="{{ url('operator/pendaftaran-cuti/create')}}"
...
@section('datatables-javascript')
    <script>
        let link = "{{ url('operator/pendaftaran-cuti') }}";
        ...
        $('#datatables').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ url('operator/pendaftaran-cuti/pendaftaran/all') }}',
            columns: [{
                    data: 'mahasiswa.nim',
                },
                {
