                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-6 text-right">
                                        <a href="{{ url('operator/surat-persetujuan-pindah/pengajuan/create')}}"
...
@section('datatables-javascript')
    <script>
        let link = "{{ url('operator/surat-persetujuan-pindah/pengajuan') }}";
        let linkSurat = "{{ url('operator/surat-persetujuan-pindah') }}";
        ...
        $('#datatables').DataTable({
                                ...
                                @if(Auth::user()->bagian == 'front office')
                                    return `<div class="d-inline-block">
                                                ...
                                                <div class="dropdown-menu navbar-dropdown border border-dark" aria-labelledby="aksi">
                                                    ...
                                                    <a href="${link+'/'+row.id}" class="dropdown-item pengajuan-surat-pindah-detail" data-toggle="modal" data-target="#suratPindah">Detail</a>
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ url('operator/surat-persetujuan-pindah/pengajuan/all') }}',
            columns: [{
                    data: 'mahasiswa.nim',
                },
                {
                            ...
                            "render": function ( data, type, row, meta ) {
                                @if(Auth::user()->bagian != 'front office')
                                    return `<div class="d-inline-block">
                                                ...
                                                <div class="dropdown-menu navbar-dropdown border border-dark" aria-labelledby="aksi">
                                                    <a href="${linkSurat+'/'+row.id}" class="dropdown-item btn-surat-pindah-detail" data-toggle="modal" data-target="#suratPindah">
                                                            Detail</a>
