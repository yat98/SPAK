                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-6 text-right">
                                        <a href="{{ url('operator/pengajuan/surat-rekomendasi/create')}}"
...
@section('datatables-javascript')
    <script>
        let link = "{{ url('operator/pengajuan/surat-rekomendasi') }}";
        let linkPengajuan = "{{ url('operator/surat-rekomendasi/pengajuan') }}";
        let linkSurat = "{{ url('operator/surat-rekomendasi') }}";
        let linkMhs = "{{ url('operator/detail/mahasiswa') }}";
        let linkOperator = "{{ url('operator/surat-rekomendasi') }}";
        ...
        $('#datatables').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ url('operator/pengajuan/surat-rekomendasi/all') }}',
            columns: [{
                    data: 'nama_kegiatan',
                },
                {
                            ...
                            "render": function ( data, type, row, meta ) {
                                <?php if(Auth::user()->bagian != 'front office'){ ?>
                                    return `<div class="d-inline-block">
                                                ...
                                                <div class="dropdown-menu navbar-dropdown border border-dark" aria-labelledby="aksi">
                                                    <a href="${linkOperator+'/'+row.id}" class="dropdown-item btn-surat-rekomendasi-detail" data-toggle="modal" data-target="#suratRekomendasi">Detail</a>
                                                    <a href="${link+'/'+row.id+'/cetak'}" class="dropdown-item">Cetak</a>
                                                </div>
                                            </div>`;
                                <?php }else{ ?>
                                    let action = `<a href="${linkOperator+'/'+row.id}" class="dropdown-item btn-surat-rekomendasi-detail" data-toggle="modal" data-target="#suratRekomendasi">Detail</a>`;
