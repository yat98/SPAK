                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-6 text-right">
                                        <a href="{{ url('operator/surat-permohonan-pengambilan-data-awal/pengajuan/create')}}"
                                ...
                                <div class="row">
                                    <div class="col text-center">
                                        ...
                                        <p class="text-muted">
                                            {{ (Session::has('search')) ? Session::get('search') : ' Pengajuan surat permohonan pengambilan data awal penelitian belum ada.' }}
                                        </p>
                                    </div>
                                </div>
                                @endif
...
@section('datatables-javascript')
    <script>
        let link = "{{ url('operator/surat-permohonan-pengambilan-data-awal/pengajuan') }}";
        let linkSurat = "{{ url('operator/surat-permohonan-pengambilan-data-awal') }}";
        ...
        $('#datatables').DataTable({
                                ...
                                @if(Auth::user()->bagian == 'front office')
                                    return `<div class="d-inline-block">
                                                ...
                                                <div class="dropdown-menu navbar-dropdown border border-dark" aria-labelledby="aksi">
                                                    ...
                                                    <a href="${link+'/'+row.id}" class="dropdown-item pengajuan-surat-data-awal-detail" data-toggle="modal" data-target="#suratDataAwal">Detail</a>
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ url('operator/surat-permohonan-pengambilan-data-awal/pengajuan/all') }}',
            columns: [{
                    data: 'mahasiswa.nim',
                },
                {
