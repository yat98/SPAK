                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-xs-12">
                                        @if ($errors->any())
                                        {{ Form::text('',null,['class'=>'form-control is-invalid file-upload-info','placeholder'=>'Upload Image','disabled'=>'disabled']) }}
                                        @else
                                    ...
                                    @if ($errors->any())
                                    <div class="text-danger mt-2">{{ $errors->first('data_mahasiswa') }}</div>
                                    @endif
                                    @if (isset($failures))
