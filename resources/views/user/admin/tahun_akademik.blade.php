                    ...
                    <div class="col-md-4 stretch-card grid-margin">
                        <div class="card bg-gradient-danger card-img-holder text-white">
                            <div class="card-body">
                                ...
                                <h2 class="mb-5">
                                    {{ isset($tahunAkademikAktif) ? $tahunAkademikAktif->tahun_akademik : 'Tidak Ada Tahun Akademik Aktif' }}
                                </h2>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <label
                                                        class="badge badge-gradient-info">{{ $tahunAkademik->status_aktif }}</label>
                                                    @else
                                                    <label
                                                        class="badge badge-gradient-dark">{{ $tahunAkademik->status_aktif }}</label>
                                                    @endif
                                                </td>
                                                <td>
