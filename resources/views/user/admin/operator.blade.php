                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-6 text-right">
                                        <a href="{{ url('admin/operator/create')}}"
    ...
    $('#datatables').DataTable({
        ...
        columnDefs: [{
                    ...
                    },
                    {
                        ...
                        "data": "nama",
                        "render": function ( data, type, row, meta ) {
                            return `<a href="${link}/${row.id}" class="operator-detail text-dark" data-toggle="modal" data-target="#exampleModal">
