<div class="row">
    <div class="col-md-10">
        ...
        <div class="form-group">
            @if(isset($pendaftaranCuti))
                <div class="form-row">
                    <div class="col-md-8 col-12">
                        {{ Form::label('file_surat_permohonan_cuti','File Surat Permohonan Cuti *(Ukuran File < 1MB)',['class'=>'mt-2']) }}
                    </div>
            ...
            @else
                {{ Form::label('file_surat_permohonan_cuti','File Surat Permohonan Cuti *(Ukuran File < 1MB)') }}
        ...
        <div class="form-group">
            @if(isset($pendaftaranCuti))
                <div class="form-row">
                    <div class="col-md-8 col-12">
                        {{ Form::label('file_krs_sebelumnya','File KRS Sebelumnya *(Ukuran File < 1MB)',['class'=>'mt-2']) }}
                    </div>
                    <div class="col-md-4 col-12 text-right">
            ...
            @else
                {{ Form::label('file_krs_sebelumnya','File KRS Sebelumnya *(Ukuran File < 1MB)') }}
        ...
        <div class="form-group">
            @if(isset($pendaftaranCuti))
                <div class="form-row">
                    <div class="col-md-8 col-12">
                        {{ Form::label('file_slip_ukt','File Slip UKT Semester Sebelumnya *(Ukuran File < 1MB)') }}
                    </div>
                    <div class="col-md-4 col-12 text-right">
