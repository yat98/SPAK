                    ...
                    <div class="col-md-4 stretch-card grid-margin">
                        <div class="card bg-gradient-info card-img-holder text-white">
                            <div class="card-body">
                                ...
                                <h6 class="card-text">
                                    <a href="{{ url('pegawai/surat-masuk') }}" class="text-white">Lihat data surat</a>
                                </h6>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4 stretch-card grid-margin">
                            <div class="card bg-gradient-info card-img-holder text-white">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-text">
                                        <a href="{{ url('pegawai/surat-keterangan-aktif-kuliah') }}" class="text-white">Lihat data surat</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 stretch-card grid-margin">
                            <div class="card bg-gradient-info card-img-holder text-white">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-text">
                                        <a href="{{ url('pegawai/surat-keterangan-kelakuan-baik') }}" class="text-white">Lihat data surat</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 stretch-card grid-margin">
                            <div class="card bg-gradient-info card-img-holder text-white">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-text">
                                        <a href="{{ url('pegawai/surat-dispensasi') }}" class="text-white">Lihat data surat</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 stretch-card grid-margin">
                            <div class="card bg-gradient-info card-img-holder text-white">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-text">
                                        <a href="{{ url('pegawai/surat-rekomendasi') }}" class="text-white">Lihat data surat</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 stretch-card grid-margin">
                            <div class="card bg-gradient-info card-img-holder text-white">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-text">
                                        <a href="{{ url('pegawai/surat-tugas') }}" class="text-white">Lihat data surat</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 stretch-card grid-margin">
                            <div class="card bg-gradient-info card-img-holder text-white">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-text">
                                        <a href="{{ url('pegawai/surat-persetujuan-pindah') }}" class="text-white">Lihat data surat</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 stretch-card grid-margin">
                                <div class="card bg-gradient-info card-img-holder text-white">
                                    <div class="card-body">
                                        ...
                                        <h6 class="card-text">
                                            <a href="{{ url('pegawai/surat-pengantar-cuti') }}" class="text-white">Lihat data surat</a>
                                        </h6>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 stretch-card grid-margin">
                                <div class="card bg-gradient-info card-img-holder text-white">
                                    <div class="card-body">
                                        ...
                                        <h6 class="card-text">
                                            <a href="{{ url('pegawai/surat-pengantar-beasiswa') }}" class="text-white">Lihat data surat</a>
                                        </h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card bg-gradient-info card-img-holder text-white">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-text">
                                        <a href="{{ url('pegawai/surat-kegiatan-mahasiswa') }}" class="text-white">Lihat data surat</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 stretch-card grid-margin">
                            <div class="card bg-gradient-success card-img-holder text-white">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-text">
                                        <a href="{{ url('pegawai/waktu-cuti') }}" class="text-white">Lihat data waktu cuti</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 stretch-card grid-margin">
                            <div class="card bg-gradient-dark card-img-holder text-white">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-text">
                                        <a href="{{ url('pegawai/pendaftaran-cuti') }}" class="text-white">Lihat data pendaftaran</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                    @elseif(Auth::user()->jabatan == 'kasubag pendidikan dan pengajaran')
                        <div class="col-md-4 stretch-card grid-margin">
                            <div class="card bg-gradient-info card-img-holder text-white">
                                <div class="card-body">
                                    <img src="{{ asset('image/circle.svg') }}" class="card-img-absolute"
                                    ...
                                    <h6 class="card-text">
                                        <a href="{{ url('pegawai/surat-keterangan-lulus') }}" class="text-white">Lihat data surat</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 stretch-card grid-margin">
                            <div class="card bg-gradient-info card-img-holder text-white">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-text">
                                        <a href="{{ url('pegawai/surat-permohonan-pengambilan-material') }}" class="text-white">Lihat data surat</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 stretch-card grid-margin">
                            <div class="card bg-gradient-info card-img-holder text-white">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-text">
                                        <a href="{{ url('pegawai/surat-permohonan-survei') }}" class="text-white">Lihat data surat</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 stretch-card grid-margin">
                            <div class="card bg-gradient-info card-img-holder text-white">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-text">
                                        <a href="{{ url('pegawai/surat-rekomendasi-penelitian') }}" class="text-white">Lihat data surat</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 stretch-card grid-margin">
                            <div class="card bg-gradient-info card-img-holder text-white">
                                <div class="card-body">
                                    ...
                                    <h6 class="card-text">
                                        <a href="{{ url('pegawai/surat-permohonan-pengambilan-data-awal') }}" class="text-white">Lihat data surat</a>
                                    </h6>
                                </div>
                            </div>
                        </div>
...
@section('datatables-javascript')
    <script>
        ...
        let linkSuratMasuk = "{{ url('pegawai/surat-masuk') }}";

        @if(Auth::user()->jabatan == 'kasubag kemahasiswaan')
            let linkSuratAktif = "{{ url('pegawai/surat-keterangan-aktif-kuliah') }}";
            let linkSuratBaik = "{{ url('pegawai/surat-keterangan-kelakuan-baik') }}";
            let linkSuratDispensasi = "{{ url('pegawai/surat-dispensasi') }}";
            let linkSuratRekomendasi = "{{ url('pegawai/surat-rekomendasi') }}";
            let linkSuratTugas = "{{ url('pegawai/surat-tugas') }}";
            let linkSuratPindah = "{{ url('pegawai/surat-persetujuan-pindah') }}";
            let linkSuratCuti = "{{ url('pegawai/surat-pengantar-cuti') }}";
            let linkSuratBeasiswa = "{{ url('pegawai/surat-pengantar-beasiswa') }}";
            let linkSuratKegiatan = "{{ url('pegawai/surat-kegiatan-mahasiswa') }}";
            let linkWaktuCuti = "{{ url('pegawai/waktu-cuti') }}";
            let linkPendaftaran = "{{ url('pegawai/pendaftaran-cuti') }}";
        @elseif(Auth::user()->jabatan == 'kasubag pendidikan dan pengajaran')
            let linkSuratLulus = "{{ url('pegawai/surat-keterangan-lulus') }}";
            let linkSuratMaterial = "{{ url('pegawai/surat-permohonan-pengambilan-material') }}";
        ...
        @if(Auth::user()->jabatan == 'kasubag kemahasiswaan')
            ...
            $('#datatables2').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ url('pegawai/surat-keterangan-kelakuan-baik/all') }}',
                columns: [{
                        data: 'mahasiswa.nama',
                    },
                    {
            ...
            $('#datatables4').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ url('pegawai/surat-rekomendasi/all') }}',
                columns: [{
                        data: 'nama_kegiatan',
                    },
                    {
            ...
            $('#datatables5').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ url('pegawai/surat-tugas/all') }}',
                columns: [{
                        data: 'nama_kegiatan',
                    },
                    {
            ...
            $('#datatables7').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ url('pegawai/surat-pengantar-cuti/all') }}',
                columns: [{
                        data: 'nomor_surat',
                    },
                    {
            ...
            $('#datatables8').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ url('pegawai/surat-pengantar-beasiswa/all') }}',
                columns: [{
                        data: 'nomor_surat',
                    },
                    {
        ...
        @if(Auth::user()->jabatan == 'kasubag pendidikan dan pengajaran')
            $('#datatables12').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ url('pegawai/surat-keterangan-lulus/all') }}',
                columns: [{
                        data: 'mahasiswa.nama',
                    },
                    {
            ...
            $('#datatables13').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ url('pegawai/surat-permohonan-pengambilan-material/all') }}',
                columns: [{
                        data: 'nama_kegiatan',
                    },
                    {
            ...
            $('#datatables14').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ url('pegawai/surat-permohonan-survei/all') }}',
                columns: [{
                        data: 'mahasiswa.nama',
                    },
                    {
            ...
            $('#datatables15').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ url('pegawai/surat-rekomendasi-penelitian/all') }}',
                columns: [{
                        data: 'mahasiswa.nama',
                    },
                    {
            ...
            $('#datatables16').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ url('pegawai/surat-permohonan-pengambilan-data-awal/all') }}',
                columns: [{
                        data: 'mahasiswa.nama',
                    },
                    {
