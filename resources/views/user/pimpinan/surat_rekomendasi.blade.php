                    ...
                    <div class="col-md-6 stretch-card grid-margin">
                        <div class="card bg-gradient-warning card-img-holder text-white">
                            <div class="card-body">
                                ...
                                <h2 class="mb-5">
                                    {{ $countAllPengajuanSuratRekomendasi > 0 ? $countAllPengajuanSuratRekomendasi.' Tanda Tangan Surat Rekomendasi' : 'Tanda Tangan Surat Rekomendasi Kosong' }}
                                </h2>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('pimpinan/surat-rekomendasi/'.$suratRekomendasi->id) }}" class="btn btn-outline-info btn-sm btn-surat-rekomendasi-detail" data-toggle="modal" data-target="#exampleModal">
                                                     ...
                                                     @if ($suratRekomendasi->status == 'diajukan' && $suratRekomendasi->nip == Session::get('nip'))
                                ...
                                <div class="row">
                                    <div class="col text-center">
                                        ...
                                        <h4 class="display-4 mt-3">
                                            {{ (Session::has('search-title')) ? Session::get('search-title') : ' Tanda Tangan Surat Rekomendasi Kosong!' }}
                                        </h4>
                                        <p class="text-muted">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> {{ $suratRekomendasi->nama_kegiatan }}</td>
                                                <td> 
                                                @if($suratRekomendasi->status == 'diproses')
                                                <label class="badge badge-gradient-warning">{{ ucwords($suratRekomendasi->status) }}</td></label>
                                                @else
                                                <label class="badge badge-gradient-info">{{ ucwords($suratRekomendasi->status) }}</td></label>
                                                @endif
                                                <td> {{ $suratRekomendasi->created_at->diffForHumans() }}</td>
