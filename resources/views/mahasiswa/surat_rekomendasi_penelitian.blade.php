                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-6 text-right">
                                        <a href="{{ url('mahasiswa/surat-rekomendasi-penelitian/pengajuan/create')}}"
...
@section('datatables-javascript')
    <script>
        let link = "{{ url('mahasiswa/surat-rekomendasi-penelitian/pengajuan') }}";
        let linkSurat = "{{ url('mahasiswa/surat-rekomendasi-penelitian') }}";
                        ...
                        },
                        {
                            ...
                            "render": function ( data, type, row, meta ) {
                                ...
                                if(row.status == 'Diajukan' || row.status == 'Ditolak'){
                                    action += `<a href="${link+'/'+row.id}" class="dropdown-item pengajuan-surat-penelitian-detail" data-toggle="modal" data-target="#suratPenelitian">Detail</a>`;
                                }else{
                                    action += `<a href="${linkSurat+'/'+row.id}" class="dropdown-item btn-surat-penelitian-detail" data-toggle="modal" data-target="#suratPenelitian">
                                                Detail</a>`;
                                }
