                    ...
                    <div class="col-md-4 stretch-card grid-margin">
                        <div class="card bg-gradient-info card-img-holder text-white">
                            <div class="card-body">
                                ...
                                <h6 class="card-text">
                                    <a href="{{ url('mahasiswa/surat-keterangan-bebas-perlengkapan') }}" class="text-white">Lihat data surat</a>
                                </h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 stretch-card grid-margin">
                        <div class="card bg-gradient-info card-img-holder text-white">
                            <div class="card-body">
                                ...
                                <h6 class="card-text">
                                    <a href="{{ url('mahasiswa/surat-keterangan-bebas-perpustakaan') }}" class="text-white">Lihat data surat</a>
                                </h6>
                            </div>
                        </div>
                    </div>
...
@section('datatables-javascript')
    <script>
        ...
        let linkPerlengkapan = "{{ url('mahasiswa/surat-keterangan-bebas-perlengkapan/pengajuan') }}";
        let linkSuratPerlengkapan = "{{ url('mahasiswa/surat-keterangan-bebas-perlengkapan') }}";

        let linkPerpustakaan = "{{ url('mahasiswa/surat-keterangan-bebas-perpustakaan/pengajuan') }}";
        let linkSuratPerpustakaan = "{{ url('mahasiswa/surat-keterangan-bebas-perpustakaan') }}";
        ...
        $('#datatables12').DataTable({
            ...
            columnDefs: [{
                        ...
                        },
                        {
                            ...
                            "data": "aksi",
                            "render": function ( data, type, row, meta ) {
                                let action = `<a href="${linkPerlengkapan+'/'+row.id}/progress" class="dropdown-item btn-surat-progress" data-toggle="modal" data-target="#exampleModal">Progres Surat</a>`;
        ...
        $('#datatables13').DataTable({
            ...
            columnDefs: [{
                        ...
                        },
                        {
                            ...
                            "data": "aksi",
                            "render": function ( data, type, row, meta ) {
                                let action = `<a href="${linkPerpustakaan+'/'+row.id}/progress" class="dropdown-item btn-surat-perpustakaan-progress" data-toggle="modal" data-target="#exampleModal">Progres Surat</a>`;
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ url('mahasiswa/surat-keterangan-bebas-perpustakaan/pengajuan/all') }}',
            columns: [{
                    data: 'mahasiswa.nim',
                },
                {
