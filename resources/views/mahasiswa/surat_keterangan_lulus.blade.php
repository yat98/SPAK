                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-12 col-md-6 text-right">
                                        <a href="{{ url('mahasiswa/surat-keterangan-lulus/pengajuan/create')}}"
...
@section('datatables-javascript')
    <script>
        let link = "{{ url('mahasiswa/surat-keterangan-lulus/pengajuan') }}";
        let linkSurat = "{{ url('mahasiswa/surat-keterangan-lulus') }}";
