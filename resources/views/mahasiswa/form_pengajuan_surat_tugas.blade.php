...
<div class="row">
    <div class="col-md-12">
        <div class="form-group ">
            ...
            @if ($errors->any())
            @if ($errors->has('nim'))
            {{ Form::select('nim[]',$mahasiswa,isset($pengajuanSurat) ? $pengajuanSurat->mahasiswa : Auth::user()->nim,['class'=>'form-control form-control-lg','id'=>'mahasiswa_list','multiple'=>"multiple"]) }}
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            {{ Form::text('jenis_kegiatan',null,['class'=>'form-control form-control-lg is-invalid','id'=>'jenis_kegiatan']) }}
            <div class="invalid-feedback">{{ $errors->first('jenis_kegiatan') }}</div>
            @else
            {{ Form::text('jenis_kegiatan',null,['class'=>'form-control form-control-lg is-valid','id'=>'jenis_kegiatan']) }}
            @endif
            @else
            {{ Form::text('jenis_kegiatan',null,['class'=>'form-control form-control-lg','id'=>'jenis_kegiatan']) }}
            @endif
        </div>
        <div class="form-group">
            ...
            {{ Form::text('tempat_kegiatan',null,['class'=>'form-control is-invalid','id'=>'tempat_kegiatan']) }}
            <div class="invalid-feedback">{{ $errors->first('tempat_kegiatan') }}</div>
            @else
            {{ Form::text('tempat_kegiatan',null,['class'=>'form-control is-valid','id'=>'tempat_kegiatan']) }}
            @endif
            @else
            {{ Form::text('tempat_kegiatan',null,['class'=>'form-control','id'=>'tempat_kegiatan']) }}
            @endif    
        </div>
        <div class="form-group">
