...
class CreateKodeSuratTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('kode_surat', function (Blueprint $table) {
            ...
            $table->enum('jenis_surat',['surat keterangan','surat dispensasi','surat pengantar cuti','surat rekomendasi','surat tugas','surat persetujuan pindah','surat pengantar beasiswa']);
            $table->timestamps();
        });
    }
